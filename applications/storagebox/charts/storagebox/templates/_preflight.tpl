{{/*
Preflight spec - defines collectors and analyzers for pre-installation checks.
Included into a Secret by replicated-preflight.yaml.
*/}}
{{- define "storagebox.preflight" -}}
kind: Preflight
apiVersion: troubleshoot.sh/v1beta2
metadata:
  name: storagebox
spec:
  uri: https://raw.githubusercontent.com/replicatedhq/platform-examples/main/applications/storagebox/charts/storagebox/templates/_preflight.tpl
  collectors:
    - clusterInfo: {}
    - clusterResources: {}
